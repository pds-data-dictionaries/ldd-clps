<?xml version="1.0" encoding="UTF-8"?>
  <!-- PDS4 Schematron for Name Space Id:clps  Version:1.1.1.0 - Mon Apr 07 17:27:11 UTC 2025 -->
...
<sch:schema xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
  ...
  <sch:pattern>
    <sch:rule context="clps:CLPS_Delivery_Information/clps:vendor_mission_name">
      <sch:assert test=". = ('Blue Ghost 1', 'Draper Lunar Lander', 'Griffin Mission One', 'Intuitive Machines Mission 1', 'Intuitive Machines Mission 2', 'Intuitive Machines Mission 3', 'Peregrine Mission 1')">
        <title>clps:CLPS_Delivery_Information/clps:vendor_mission_name/clps:vendor_mission_name</title>
        The attribute clps:CLPS_Delivery_Information/clps:vendor_mission_name must be equal to one of the following values 'Blue Ghost 1', 'Draper Lunar Lander', 'Griffin Mission One', 'Intuitive Machines Mission 1', 'Intuitive Machines Mission 2', 'Intuitive Machines Mission 3', 'Peregrine Mission 1'.</sch:assert>
    </sch:rule>
  </sch:pattern>
  <sch:pattern>
